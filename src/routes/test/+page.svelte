...
<script>
  ...
  onMount(() => {
    ...
    root.style.setProperty('--fs-heading', '36px');
    root.style.setProperty('--fs-text', '26px');
    root.style.setProperty('--fs-button', '18px');
    root.style.setProperty('--fs-icon', '30px');
    root.style.setProperty('--pupil-size', '30px');
    root.style.setProperty('--eye-size', '80px');
    root.style.setProperty('--button-padding', '15px 30px');

    const mediaQuery = window.matchMedia('(max-width: 567px)');
    if (mediaQuery.matches) {
      root.style.setProperty('--fs-heading', '30px');
      root.style.setProperty('--fs-text', '22px');
      root.style.setProperty('--fs-button', '16px');
      root.style.setProperty('--fs-icon', '24px');
...
<button class="color-switcher" on:click={switchTheme}>
